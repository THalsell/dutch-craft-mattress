...
export default function FactoryApplicationPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    references.forEach((r, i) => {
      refsHtml += subhead(`Reference ${i + 1}`) +
        table(
    ...
    const html = wrapEmailHtml("Factory Application", body);
  ...
  return (
    <ApplicationShell
      ...
      pdfHref="/careers/factory-application.pdf"
