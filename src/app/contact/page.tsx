        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              <svg className="w-8 h-8 mx-auto mb-4 text-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a href={`tel:${contact.phoneTel}`} className="text-sage hover:text-sage/80 font-medium">{contact.phone}</a>
            </div>
