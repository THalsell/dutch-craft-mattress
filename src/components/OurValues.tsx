  ...
  return (
    <section className="py-20 md:py-28 bg-fog">
      <div className="max-w-5xl mx-auto px-6">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-charcoal text-center mb-4">Our Values</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white rounded-lg p-8 text-center shadow-sm hover:shadow-md transition-shadow">
            <div className="w-14 h-14 bg-sky-300/20 rounded-full flex items-center justify-center mx-auto mb-5">
