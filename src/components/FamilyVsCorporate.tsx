    ...
    <section className="py-16 md:py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Family Owned vs. Corporate Driven</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="border border-border rounded-lg p-8">
            <h3 className="text-xl font-semibold text-charcoal mb-4">Corporate Mattress Companies</h3>
          ...
          <div className="border-2 border-sage rounded-lg p-8 bg-sage/5">
            <h3 className="text-xl font-semibold text-charcoal mb-4">Dutch Craft</h3>
            <ul className="space-y-3 text-slate text-sm">
              {dutchCraft.map((item) => (
                <li key={item} className="flex gap-3">
